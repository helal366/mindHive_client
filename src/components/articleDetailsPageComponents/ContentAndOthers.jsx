...
const ContentAndOthers = ({singleArticle}) => {
    ...
    return (
        <>
            ...
            <p className="font-medium text-base sm:text-lg md:text-xl mb-1 md:mb-2 opacity-80">
              <span>Article Category: </span>
              {category}
            </p>
            <p className="opacity-60 text-xs sm:text-sm md:text-base text-justify mb-2 sm:mb-4">
              {content}
            </p>
