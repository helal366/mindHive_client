...
const ThumbnailPhoto = ({singleArticle}) => {
    ...
    return (
        <>
            <div className="w-full max-h-[85%] shadow-2xl shadow-neutral-300 rounded-2xl px-[2vw] md:px-[5vw] lg:px-[10vw] py-[2vh] sm:py-[5vh] md:py-[6vh] bg-base-200 mb-4 md:mb-8 lg:mb-10">
